...
def build_pymc_model(times, total_obs, dead_obs):
    ...
    with pm.Model() as model:
        ...
        Qn = pm.Uniform("Qn", 2.5e-10, 30e-10)
...
if __name__ == "__main__":
    ...
    file_path = '../res/ehux_monod_QNflat.nc'
    # Build and run model
    ...
    if plot_trace_flag:
        ...
        var_order=['mu_max','delta','Qn','N0','P0','D0','sigma_live','sigma_dead'],
        hspace=0.8,
        wspace=0.3,
        ...
        save_path='../figures/ehux_monod_trace_QNflat.svg'
        )
    ...
    if plot_posterior_pairs_flag:
        ...
        hspace=0.3,
        wspace=0.3,
        save_path='../figures/ehux_monod_posterior_QNflat.svg'
        )
    ...
    if plot_convergence_flag:
        plot_convergence(
            ...
            figsize=(10, 10),
            save_path="../figures/ehux_monod_convergence_QNflat.svg"
            )
