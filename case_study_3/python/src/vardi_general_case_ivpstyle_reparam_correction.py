...
def run_inference(model, draws=20000, tune=20000, chains=3, cores=3, threshold_for_slice=5,target_accept=0.9):
    with model:
...
if __name__ == "__main__":
    ...
    file_path = '../res/vardi_general_chain_reparam_corr.nc'
    # Build and run model
